...
ResponseGET::ResponseGET(ResponseInfo info) : 
    ...
    m_serverRoot(info.m_serverRoot),
...
void ResponseGET::prepareResponce() {
    if(validateLocation(m_serverRoot, m_requestLocation) && isFileExists(m_requestLocation)) {
...
int ResponseGET::getNextChank() {
    ...
    return read(m_fileFd, m_buffer, bufferSize);
}
